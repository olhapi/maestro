...
- disabled `review` and `done` phases with starter prompt text already filled in, including done-phase guidance for a short reviewer preview video when local demo tooling is available
