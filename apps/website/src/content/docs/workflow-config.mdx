...
- disabled `review` and `done` phases with starter prompt text already filled in, including done-phase guidance focused on merge-back, PR readiness, and blocker reporting
