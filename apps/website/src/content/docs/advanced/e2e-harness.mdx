...
description: Run the deterministic end-to-end harness when you need to verify the full Maestro-to-Codex handoff with the real CLI.
section: advanced
order: 0
