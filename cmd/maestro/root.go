...
func (a *cliApp) newIssueListCmd() *cobra.Command {
	...
	cmd.Flags().StringVar(&sortBy, "sort", sortBy, "Sort: updated_desc, updated_asc, created_asc, priority_asc, priority_desc, identifier_asc, identifier_desc, state_asc, state_desc, project_asc, project_desc, epic_asc, epic_desc")
